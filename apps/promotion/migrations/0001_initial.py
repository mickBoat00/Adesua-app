    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='COursesOnPromotion', to='course.course')),
            ],
        ),
        migrations.CreateModel(
            name='PromoType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('courses_on_promotion', models.ManyToManyField(related_name='courses_on_promotion', through='promotion.CoursesOnPromotion', to='course.course')),
